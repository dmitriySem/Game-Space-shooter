...
public class EnemyEmitter {
    ...
    private static final int ENEMY_BIG_BULLET_DAMEGE = 10;
    ...
    public void generate(float delta, int frag){
        ...
        if (generateTimer >= GENERATE_INTERVAL) {
            ...
            if (type < 0.5f) {
                enemy.set(
                        ...
                        ENEMY_SMALL_BULLET_DAMEGE * level,
                        bulletSound,
                ...
                enemy.set(
                        ...
                        ENEMY_MEDIUM_BULLET_DAMEGE * level,
                        bulletSound,
